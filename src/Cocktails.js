...
import cocktailPic from './Cocktails.jpg';
...
function Cocktails(props) {
  return (
    <div className="Cocktail-page">
      <img className="Header-pic" alt="" src={cocktailPic} />
        ...
        <ul className="Food-flex">
          {cocktails.map(cocktail => (
            <li>
              ...
              <button type="button" onClick={() => props.cocktailOrder(cocktail, 'cocktail')}>Add to order</button>
            </li>
          ))}
        </ul>
      </div>
